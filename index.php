...
<head>
    ...
    <title>Tugas Cristo Tallo</title>
...
<body>
    <div class="container">
        ...
        <form name="Aktivitas" action="#" method="post">
            <input type="text" placeholder="Buat Kegiatanmu..." name="tugas" value="<?php echo isset($_SESSION['edit_index']) ? htmlspecialchars($_SESSION['tugas'][$_SESSION['edit_index']]['nama']) : ''; ?>" required>
